...
public class Tess4jImgCheck {
	    ...
	    public Tess4jImgCheck(BufferedImage img) throws IOException {
	        this.img = img;
	        init();
	    }

	    
	    public Tess4jImgCheck(File file) throws IOException {
	        img = ImageIO.read(file);
	        init();
	    }

	    
	    public Tess4jImgCheck(URL url) throws IOException {
